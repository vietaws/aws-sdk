...
class RestoreDBClusterFromS3Command extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.RestoreDBClusterFromS3MessageFilterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.RestoreDBClusterFromS3ResultFilterSensitiveLog,
        };
